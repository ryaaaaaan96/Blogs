...
## 1.1 举例
从水龙头放水
![企业微信截图_17103115145051](pic/企业微信截图_17103115145051.png)
## 1.2 适用环境
二阶以内的线性系统（齐次性叠加性）
齐次性`y = f(x)` => `ky = f(kx)`
...
**一阶系统**
![Pasted image 20240313144009](pic/Pasted%20image%2020240313144009.png)
**二阶系统**
![Pasted image 20240313144103](pic/Pasted%20image%2020240313144103.png)
## 1.3 PID不适用的系统
高阶系统 ——化简为二阶系统
...
## 2.1 控制系统知识
1. 一般开环控制系统
![企业微信截图_17103124156504](pic/企业微信截图_17103124156504.png)
不论输出效果怎么样都不管
2. 前馈控制系统
![企业微信截图_17103128804226](pic/企业微信截图_17103128804226.png)
提前测量出对象中的干扰，在输入端把干扰给补偿掉
3. 闭环控制系统
![企业微信截图_1710312988171](pic/企业微信截图_1710312988171.png)
对被控对象进行测量，偏差信号用于调整控制器
4. 双闭环控制系统
![企业微信截图_17103131811124](pic/企业微信截图_17103131811124.png)
...
5. 复合控制系统
多种控制综合起来
![企业微信截图_17103140057903](pic/企业微信截图_17103140057903.png)
PID能解决95%的问题，前馈反馈能解决剩下5%中的95%
## 2.2 离散控制信号
![企业微信截图_171031450253](pic/企业微信截图_171031450253.png)
![企业微信截图_1710314564960](pic/企业微信截图_1710314564960.png)
这种离散方式导致信号出现了一个滞后
# 3 PID入门
## 3.1 公式
![企业微信截图_17103148133503](pic/企业微信截图_17103148133503.png)
## 3.2 形象解释
![企业微信截图_17103157243367](pic/企业微信截图_17103157243367.png)
纯理想状态下只用p是永远无法精确到达目标位置的
![企业微信截图_17103162344574](pic/企业微信截图_17103162344574.png)
在有外力作用的情况下会停在一个地方不动了，这个时候就需要积分项，
![企业微信截图_1710316311369](pic/企业微信截图_1710316311369.png)
积分项会带来超调，微分项的作用是降低超调
![企业微信截图_17103167314797](pic/企业微信截图_17103167314797.png)
## 3.2 PID参数的整定
模型整定法（建模）
工程经验整定法
## 3.3 变种
...
![企业微信截图_17103183074551](pic/企业微信截图_17103183074551.png)
- 抗饱和积分
...
![Pasted image 20240313170350](pic/Pasted%20image%2020240313170350.png)
...
### 4.2.1 针对给定进行
传统PI调节
![Pasted image 20240617104226](pic/Pasted%20image%2020240617104226.png)
带有前馈的PI调节（前馈转换成一个比例模型）
![Pasted image 20240617104324](pic/Pasted%20image%2020240617104324.png)

分析传递函数可以得出，前馈控制器只能影响系统的零点不会修改原系统的极点，（前馈可能会引入新的极点）
设前馈的误差传递函数为Gf，目标为使传递函数的零点为0；
![Pasted image 20240617104828](pic/Pasted%20image%2020240617104828.png)
前馈环节和被控对象在大多数情况下的关系是互为倒数（在Gb（s）不为1的时候需要将反馈函数带入计算）：
![Pasted image 20240617105301](pic/Pasted%20image%2020240617105301.png)

### 4.2.2 针对误差进行
前馈不止可以针对给定信号，也可以针对干扰信号进行前馈，计算出干扰信号的前馈传递函数，如下图
![Pasted image 20240617110226](pic/Pasted%20image%2020240617110226.png)
...
![Pasted image 20240617112949](pic/Pasted%20image%2020240617112949.png)
