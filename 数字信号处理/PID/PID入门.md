...
**一阶系统**
![Pasted image 20240313144009](pic/Pasted image 20240313144009.png)
**二阶系统**
![Pasted image 20240313144103](pic/Pasted image 20240313144103.png)
## 1.3 PID不适用的系统
高阶系统 ——化简为二阶系统
...
![Pasted image 20240313170350](pic/Pasted image 20240313170350.png)
...
### 4.2.1 针对给定进行
传统PI调节
![Pasted image 20240617104226](pic/Pasted image 20240617104226.png)
带有前馈的PI调节（前馈转换成一个比例模型）
![Pasted image 20240617104324](pic/Pasted image 20240617104324.png)

分析传递函数可以得出，前馈控制器只能影响系统的零点不会修改原系统的极点，（前馈可能会引入新的极点）
设前馈的误差传递函数为Gf，目标为使传递函数的零点为0；
![Pasted image 20240617104828](pic/Pasted image 20240617104828.png)
前馈环节和被控对象在大多数情况下的关系是互为倒数（在Gb（s）不为1的时候需要将反馈函数带入计算）：
![Pasted image 20240617105301](pic/Pasted image 20240617105301.png)

### 4.2.2 针对误差进行
前馈不止可以针对给定信号，也可以针对干扰信号进行前馈，计算出干扰信号的前馈传递函数，如下图
![Pasted image 20240617110226](pic/Pasted image 20240617110226.png)
...
![Pasted image 20240617112949](pic/Pasted image 20240617112949.png)
