...
__initial_sp
```
![Pasted image 20231027160610](../pic/Pasted%20image%2020231027160610.png)
## 设置堆区，//堆区使用待补充
```
;堆初始化
;定义堆区的大小
...
__heap_limit
```
![Pasted image 20231027160735](../pic/Pasted%20image%2020231027160735.png)
## 中断向量表部分
...
![Pasted image 20231027160751](../pic/Pasted%20image%2020231027160751.png)
...
![Pasted image 20231027161932](../pic/Pasted%20image%2020231027161932.png)
`__Vectors_End`
...
![Pasted image 20231027162501](../pic/Pasted%20image%2020231027162501.png)

## 中断服务程序
都是weak声明，可以在用户区自定义，没有定义则表示会进入死循环。
![Pasted image 20231027163246](../pic/Pasted%20image%2020231027163246.png)
![Pasted image 20231027163538](../pic/Pasted%20image%2020231027163538.png)
## 文件最后是初始化用户栈区
![Pasted image 20231027162958](../pic/Pasted%20image%2020231027162958.png)
