...
# 1 GPIO中的四个关键器件介绍
![Pasted image 20230924093421](../pic/Pasted image 20230924093421.png)
...
![Pasted image 20230924145727](../pic/Pasted image 20230924145727.png)
## 2.2、浮空输入
 ...
 ![Pasted image 20230924150415](../pic/Pasted image 20230924150415.png)
## 2.3、下拉输入
...
![Pasted image 20230924150627](../pic/Pasted image 20230924150627.png)
...
![Pasted image 20230924150849](../pic/Pasted image 20230924150849.png)
## 2.5、开漏输出
...
![Pasted image 20230924151120](../pic/Pasted image 20230924151120.png)
![Pasted image 20230924151417](../pic/Pasted image 20230924151417.png)
## 2.6、推挽输出
...
![Pasted image 20230924152347](../pic/Pasted image 20230924152347.png)

![Pasted image 20230924152333](../pic/Pasted image 20230924152333.png)
## 2.7、复用开漏输出（由外设控制器控制）
...
![Pasted image 20230924152841](../pic/Pasted image 20230924152841.png)
## 2.8、复用推挽输出（由外设控制器控制）
GPIO的引脚用作串口的输出，则使用复用推挽输出模式（注：输出的高低电平的来源，不是让CPU直接写输出数据寄存器，取而代之利用片上外设模块的复用功能输出来决定的）。
![Pasted image 20230924152923](../pic/Pasted image 20230924152923.png)
# 三、推挽和开漏的总结
## 3.1、推挽结构和推挽电路
...
# 4. 外设的GPIO配置
## 4.1、高级定时器TIM1/TIM8
![Pasted image 20230924154405](../pic/Pasted image 20230924154405.png)
## 4.2、通用定时器TIM2/3/4/5

![Pasted image 20230924154423](../pic/Pasted image 20230924154423.png)
## 4.3、USART
![Pasted image 20230924154449](../pic/Pasted image 20230924154449.png)
## 4.4、SPI
![Pasted image 20230924154511](../pic/Pasted image 20230924154511.png)

## 4.5、I2S
![Pasted image 20230924154528](../pic/Pasted image 20230924154528.png)
## 4.6、I2C
![Pasted image 20230924154550](../pic/Pasted image 20230924154550.png)

## 4.7、BxCAN
![Pasted image 20230924154639](../pic/Pasted image 20230924154639.png)

## 4.8、USB
![Pasted image 20230924154705](../pic/Pasted image 20230924154705.png)

## 4.9、全速USB OTG引脚配置
![Pasted image 20230924154727](../pic/Pasted image 20230924154727.png)
![Pasted image 20230924154742](../pic/Pasted image 20230924154742.png)
## 4.10、SDIO
![Pasted image 20230924154805](../pic/Pasted image 20230924154805.png)

## 4.11、ADC/DAC
![Pasted image 20230924154822](../pic/Pasted image 20230924154822.png)

## 4.12、FSMC
![Pasted image 20230924154840](../pic/Pasted image 20230924154840.png)

## 4.13、其它I/O功能
![Pasted image 20230924154904](../pic/Pasted image 20230924154904.png)
