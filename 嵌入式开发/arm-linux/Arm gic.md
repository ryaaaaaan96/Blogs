...
![Pasted image 20240308091334](pic/Pasted image 20240308091334.png)
...
![Pasted image 20240308091941](pic/Pasted image 20240308091941.png)
>GIC检测中断流程如下：
...
- 其他
**中断生命周期**
![Pasted image 20240308092407](pic/Pasted image 20240308092407.png)
- start：中断开始
...
# 2. GIC V2
![Pasted image 20240308092907](pic/Pasted image 20240308092907.png)
...
- 对于cpu interface的寄存器，增加系统寄存器访问方式
    ![Pasted image 20240308105357](pic/Pasted image 20240308105357.png)
包含了以下的组件：  
...
![Pasted image 20240308110315](pic/Pasted image 20240308110315.png)
每个core，连接一个cpu interface，而cpu interface会连接gic中的一个redistributor。redistributor的标识和core的标识一样。
![Pasted image 20240308110539](pic/Pasted image 20240308110539.png)
**中断生命周期**(和V2一致)
![Pasted image 20240308111430](pic/Pasted image 20240308111430.png)
- generate：外设发起一个中断
...
![Pasted image 20240308111636](pic/Pasted image 20240308111636.png)
