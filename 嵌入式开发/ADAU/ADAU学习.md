...
![Pasted image 20240801150649](pic/Pasted image 20240801150649.png)

反离散傅里叶变化后时域数据后的计算如下:
y[n] = (b0/a0)\*x[n] + (b1/a0)\*x[n-1] + (b2/a0)\*x[n-2]- (a1/a0)\*y[n-1] - (a2/a0)\*y[n-2]

对于ADAU的操作中常用变量的操作如下:
![Pasted image 20240801151353](pic/Pasted image 20240801151353.png)
![Pasted image 20240801151435](pic/Pasted image 20240801151435.png)
对于滤波器中的常见参数如下
...
![Pasted image 20240801150614](pic/Pasted image 20240801150614.png)
